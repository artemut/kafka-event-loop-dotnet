...
namespace Kafka.EventLoop.DependencyInjection
{
    internal sealed class IntakeScope<TMessage> : IIntakeScope<TMessage>
    {
        ...
        private readonly Func<IServiceProvider, IKafkaIntakeFilter<TMessage>> _intakeFilterProvider;
        ...
        public IntakeScope(
            ...
            Func<IServiceProvider, IKafkaIntakeFilter<TMessage>> intakeFilterProvider,
        ...
        public IKafkaIntakeFilter<TMessage> GetIntakeFilter()
        {
            return _intakeFilterProvider(_scope.ServiceProvider);
        }
