...
namespace Kafka.EventLoop.DependencyInjection
{
    internal class DependencyRegistry
    {
        ...
        public Dictionary<string, Func<IServiceProvider, string, object>> KafkaConsumerFactories { get; } = new();
        ...
        public Dictionary<string, Func<IServiceProvider, string, IKafkaWorker>> KafkaWorkerFactories { get; } = new();
    }
}
