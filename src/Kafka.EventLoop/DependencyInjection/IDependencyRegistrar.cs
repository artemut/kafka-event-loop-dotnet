...
namespace Kafka.EventLoop.DependencyInjection
{
    internal interface IDependencyRegistrar
    {
        ...
        void AddCustomPartitionMessagesFilter<TFilter>(string groupId) where TFilter : class;
        ...
        void AddCustomStreamingMessageSerializer<TSerializer>(string groupId) where TSerializer : class;
