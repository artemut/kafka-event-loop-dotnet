...
{
    internal class PartialIntakeStrategyController : IKafkaController<ProductOrderModel>
    {
        private const string GroupId = "event-loop--partial-intake-strategy-group--1-consumer";
        private readonly EventsInterceptor _eventsInterceptor;

        public PartialIntakeStrategyController(EventsInterceptor eventsInterceptor)
        {
